const zh_HK = {
  ...
  deploy_agent: {
    ...
    table: {
      ...
      ssh_port: 'SSH 連接埠',
      credential: '憑證',
      credential_placeholder: '選擇已有憑證',
      new_credential: '+ 新建憑證',
      remove: '刪除',
    },
    source_local: '本地包',
    source_remote: '遠端安裝',
    source_remote_disabled_tip: '僅聯網環境可用；目前 center 無法連接 api.github.com',
    reuse_package_placeholder: '選擇已上傳的 Categraf 包',
    upload_new: '上傳新包…',
    install_dir: '安裝目錄',
    ...
    upload_modal: {
      ...
      arch: '架構',
      file: '包檔案',
      upload_text: '拖曳 tar.gz / tgz 到此處，或點擊上傳',
      upload_hint: '上傳後自動歸檔，後續可直接複用',
      success: '包已上傳並歸檔',
    },

    run: {
      back_to_form: '返回表單',
      progress_summary: '進度：成功 {{success}} / 失敗 {{failed}} / 進行中 {{running}} / 等待 {{pending}}，總計 {{total}}',
      step_connect: '連線',
      step_upload: '上傳',
      step_extract: '解壓',
      step_render: '渲染設定',
      step_systemd: 'systemd 啟動',
      step_verify: '驗證',
      status_pending: '等待',
      status_running: '運行中',
      status_success: '成功',
