const ru_RU = {
  ...
  matrix: {
    headerKicker: 'Матрица продуктов',
    headerSubtitle: 'От ингестии данных до восстановления инцидентов — полный жизненный цикл',
    scenarioTag: 'Сценарии · Единая надёжность',
